...
def write_to_disk(image, face_coordinates):
    # tThis function will save the cropped image from original photo on disk
...
def face_detection(image):
    ...
    for (i, face) in enumerate(faces_hog):
        ...
        # Drawing rectangle around found faces
    ...
    # write in the top left corner of the image for color identification
...
if __name__ == "__main__":
    ...
    HOME = r"C:\Users\jbsch\PycharmProjects\face-recognition-kbs\images"
